export function calculateDeliveryCharge(distanceKm: number, subtotal = 0, isInternational = false) {
...
export function isInternationalShipping(customerCountry?: string, adminCountry = 'India') {
